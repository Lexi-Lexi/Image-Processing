...
public class TestImage extends JPanel{
	...
	public static void main(String[] args) {
		...
		IKImage image1 = new IKImage("roof.jpg");  // load first image file using constructor
		IKImage image2 = new IKImage();      	// object for second image file 
		image2.loadImage("dip.jpg");			// load second image file using method
		
		// first output image by size constructor
		IKImage image1out = new IKImage(image1.getWidth(), image1.getHeight(), 
										image1.getType(), "roof_out.jpg"); 
		// second output image by copy constructor
		IKImage image2out = new IKImage(image2, "dip_out.jpg"); 
		...
		image2out.saveImage("dip_out.jpg");	// showing the second image
		image2out.show(); 
